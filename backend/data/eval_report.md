...
Scored against `data/eval_sample.csv` — 180 reviews, disjoint from the 180-review sample used to build the taxonomy, never seen by the tagging prompt as few-shot material. Predictions pulled from `data/tagged_reviews.csv` (original/baseline prompt).

## Headline metrics

- **Subcategory-level micro-F1**: 0.637 (precision 0.596, recall 0.683)
- **Subcategory-level macro-F1**: 0.611 (all 39 subcategories, zero-support ones counted) / 0.645 (only the 35 subcategories with at least 1 human-labeled example in this eval set)
- **Parent-level micro-F1**: 0.773 (precision 0.739, recall 0.811)
- **Parent-level macro-F1**: 0.712 / 0.772 (only the 12 parents with support in this eval set)
- **Multi-label exact-match rate** (subcategory set == human set exactly): 41.7%
- **Multi-label exact-match rate** (parent set): 56.7%
- **Mean per-review Jaccard similarity** (subcategory level, partial credit): 0.594
...
|---|---|---|---|---|---|---|---|
| metric_accuracy | 36 | 20 | 0 | 16 | 100.0% | 55.6% | 0.714 |
| feature_ui_friction | 32 | 11 | 5 | 21 | 68.8% | 34.4% | 0.458 |
| price_value_perception | 20 | 19 | 9 | 1 | 67.9% | 95.0% | 0.792 |
| ongoing_disconnects | 18 | 16 | 3 | 2 | 84.2% | 88.9% | 0.865 |
| activity_detection | 13 | 4 | 0 | 9 | 100.0% | 30.8% | 0.471 |
| support_resolution_quality | 12 | 8 | 2 | 4 | 80.0% | 66.7% | 0.727 |
| billing_disputes | 12 | 10 | 3 | 2 | 76.9% | 83.3% | 0.800 |
| sleep_accuracy | 11 | 7 | 1 | 4 | 87.5% | 63.6% | 0.737 |
| crashes_freezes | 10 | 8 | 8 | 2 | 50.0% | 80.0% | 0.615 |
| update_failures | 10 | 7 | 4 | 3 | 63.6% | 70.0% | 0.667 |
| onboarding_pairing | 9 | 6 | 0 | 3 | 100.0% | 66.7% | 0.800 |
| sleep_satisfaction | 8 | 5 | 5 | 3 | 50.0% | 62.5% | 0.556 |
| data_sync_delays | 7 | 7 | 4 | 0 | 63.6% | 100.0% | 0.778 |
| missing_activity_types | 7 | 2 | 5 | 5 | 28.6% | 28.6% | 0.286 |
...
| comfort_fit | 4 | 3 | 3 | 1 | 50.0% | 75.0% | 0.600 |
| build_quality_perception | 4 | 4 | 5 | 0 | 44.4% | 100.0% | 0.615 |
| ai_reliability_bugs | 4 | 4 | 2 | 0 | 66.7% | 100.0% | 0.800 |
| plan_trial_structure | 3 | 3 | 3 | 0 | 50.0% | 100.0% | 0.667 |
| support_satisfaction | 3 | 2 | 1 | 1 | 66.7% | 66.7% | 0.667 |
| android_specific_bugs | 3 | 3 | 2 | 0 | 60.0% | 100.0% | 0.750 |
| support_responsiveness | 2 | 2 | 3 | 0 | 40.0% | 100.0% | 0.571 |
...
| redesign_regression | 2 | 2 | 16 | 0 | 11.1% | 100.0% | 0.200 |
...
| sleep_alarm_ui | 1 | 1 | 1 | 0 | 50.0% | 100.0% | 0.667 |
| third_party_integration | 1 | 1 | 2 | 0 | 33.3% | 100.0% | 0.500 |
| notification_community_issues | 1 | 0 | 1 | 1 | 0.0% | 0.0% | 0.000 |
| english_jargon_complexity | 0 | 0 | 0 | 0 | n/a | n/a | n/a |
| ecg_bp_feature_reliability | 0 | 0 | 3 | 0 | 0.0% | n/a | 0.000 |
| cardiac_detection_trust | 0 | 0 | 0 | 0 | n/a | n/a | n/a |
| strap_clasp_durability | 0 | 0 | 2 | 0 | 0.0% | n/a | 0.000 |
...
| ui_ux | 34 | 24 | 8 | 10 | 75.0% | 70.6% | 0.727 |
| sync_connectivity | 33 | 31 | 4 | 2 | 88.6% | 93.9% | 0.912 |
| pricing_billing | 32 | 32 | 8 | 0 | 80.0% | 100.0% | 0.889 |
| app_stability | 20 | 16 | 10 | 4 | 61.5% | 80.0% | 0.696 |
| sleep_tracking | 20 | 15 | 5 | 5 | 75.0% | 75.0% | 0.750 |
| customer_support | 17 | 15 | 2 | 2 | 88.2% | 88.2% | 0.882 |
| feature_requests | 16 | 15 | 14 | 1 | 51.7% | 93.8% | 0.667 |
| ai_coach | 11 | 10 | 2 | 1 | 83.3% | 90.9% | 0.870 |
| hardware_wearability | 10 | 10 | 8 | 0 | 55.6% | 100.0% | 0.714 |
| platform_parity | 5 | 5 | 5 | 0 | 50.0% | 100.0% | 0.667 |
| localization | 2 | 2 | 1 | 0 | 66.7% | 100.0% | 0.800 |
| health_signal_reliability | 0 | 0 | 3 | 0 | 0.0% | n/a | 0.000 |
...
|---|---|---|---|---|---|
| app_stability vs sync_connectivity | 1 | 0 | 1 | 13 | 1 |
| data_accuracy vs health_signal_reliability | 2 | 0 | 2 | 20 | 14 |
...
I can’t seem to customize the home screen to see heart rate (seems like something core, over selling me stuff)…"
  ...
  - predicted: ai_reliability_bugs;missing_metrics;price_value_perception;redesign_regression;upsell_pressure
...
- **[MISMATCH]** review_id `13665043393` [app_store, 3-star]
  ...
  - predicted: ai_autonomy;metric_accuracy;redesign_regression
- **[MATCH]** review_id `13585882883` [app_store, 2-star]
  ...
  - predicted: ai_reliability_bugs;feature_ui_friction
- **[MISMATCH]** review_id `14177657644` [app_store, 5-star]
  ...
  - human: ai_positive_reception;metric_accuracy
  - predicted: ai_positive_reception;ecg_bp_feature_reliability;price_value_perception
...
3 eval review(s) touched by this category (human tag, predicted tag, or both).
...
### review_id `13551987025` [app_store, 1-star] — Jaccard 0.14
...
### review_id `c30ff91e-2b58-4f67-ba81-6819fb2d9c69` [google_play, 2-star] — Jaccard 0.17

> Received my 4.0 quickly after posting review. It paired up easily; however, updating the app is not going through? Have attempted and reattempted to connect my 3.0 to my new S21. No help and no real concern. The date is 3.1.22 and there is major connectivity issues that remain. I will not be renewing as there is not any personal assistance for me and there is no reason to pay for a non-functioning device.

- **Human**: onboarding_pairing;support_resolution_quality;update_failures
  - human notes: Review reports three distinct issues: app update failures, inability to pair an existing WHOOP 3.0 with a new Samsung S21, and dissatisfaction with the quality of customer support. Mention of not renewing the subscription is a consequence of these issues, not a pricing complaint.
- **Predicted**: ongoing_disconnects;price_value_perception;support_responsiveness;update_failures
...
### review_id `13701432930` [app_store, 2-star] — Jaccard 0.20

> Honestly I will probably never use this app again unless I have more scientific data and real-true information. The application itself is not very user friendly as someone who actually grew with the technology over the years. After not renewing my subscription it will not let me look at past data for one. Who knows how much of my personal data it has collected in the last year without reciprocating information back to me. This is not including all the “private” information it takes from your phone and personal lives. Very disappointed.

Update: new whoop band is extremely difficult to re pair with Bluetooth after an app update. Very frustrating every time.

- **Human**: feature_ui_friction;ongoing_disconnects;price_value_perception
  - human notes: Review raises three primary issues: poor app usability, dissatisfaction with losing access to historical data after subscription expiration, and repeated Bluetooth re-pairing problems after an app update. Reviewer also expresses privacy concerns about data collection, which are outside the scope of the current taxonomy.
- **Predicted**: billing_disputes;ongoing_disconnects;update_failures
...
### review_id `13859918146` [app_store, 3-star] — Jaccard 0.00

> After the latest upgrade , whoop device has a hard time pairing

- **Human**: onboarding_pairing
  - human notes: Primary fit: onboarding pairing. Possible overlap with update failures.
- **Predicted**: ongoing_disconnects;update_failures
...
- **Predicted**: data_sync_delays;ongoing_disconnects
...
### review_id `14285949714` [app_store, 4-star] — Jaccard 0.00

> I’ve been enjoying my WHOOP overall, but there are a couple of features I’d love to see added. First, it would be great if there were a “Find My WHOOP” feature. I’ve had to remove it a few times and I’ve misplaced it and my charger more than once.
Second, I think it would be helpful to have an optional display that shows the time. I know WHOOP is designed as a fitness and recovery tracker rather than a traditional watch, but being able to quickly check the time would make it even more convenient.
I’ve only had my WHOOP since December, so I’m still learning how to interpret all of the data it provides. The insights have been valuable, and I’m continuing to discover new features. Overall, I’m happy with it and look forward to getting even more out of it as I use it longer.

- **Human**: personalization_use_case_fit
  - human notes: Reviewer requests two new capabilities: a "Find My WHOOP" feature and an optional on-device time display. These are feature additions rather than UI usability issues. Current taxonomy lacks a generic "missing features" subcategory, so personalization_use_case_fit is the closest available fit.
- **Predicted**: missing_activity_types;missing_metrics
...
### review_id `14197690581` [app_store, 5-star] — Jaccard 0.25

> I’ve been using the WHOOP for almost a year now and it’s helped me to better manage my chronic illnesses and even helped me in managing my PTSD. I love the AI function where I can speak to it about any new concerns or changes and it always has an answer that’s backed up by research. It’s even helped me in guarding me to go to the doctor in letting me know that I’m probably ill based on recent data. I think the coolest thing is that it attracts your sleep and educates you on every little bit of life and why sleep affects strain output and HRV and resting heart rate, etc

- **Human**: ai_positive_reception;metric_accuracy
  - human notes: Core complaint spans metric accuracy and ai positive reception; kept both because they read as separate but related issues.
- **Predicted**: ai_positive_reception;personalization_use_case_fit;sleep_satisfaction

### review_id `a4602e36-cc21-4f97-a512-027c77442742` [google_play, 3-star] — Jaccard 0.25

> Promising health monitor BUT the app needs to be less disorganised. Insights are informative. The graphs and charts are not helpfully labelled on any of the axis and there is an overuse of weekly/monthly summarised statistics accompanied by a complete lack of daily graph data which could show details of heart rate, rhr, hrv etc. The stress monitor is excellent - we need more charts like this. For activities, just let the user add in manually - it's not necessary to try to list every one!

- **Human**: metric_accuracy;missing_activity_types
  - human notes: Core complaint spans metric accuracy and missing activity types; kept both because they read as separate but related issues. Also more graphical visuals with respect to activity types and labelling can be better.
- **Predicted**: missing_activity_types;missing_metrics;redesign_regression
