...
Scored against `data/eval_sample.csv` — 180 reviews, disjoint from the 180-review sample used to build the taxonomy, never seen by the tagging prompt as few-shot material. Predictions pulled from `tagged_reviews_eval_variantA_instr_only.csv` (variant A: instruction-only, eval-only re-tag).

## Headline metrics

- **Subcategory-level micro-F1**: 0.618 (precision 0.587, recall 0.653)
- **Subcategory-level macro-F1**: 0.582 (all 39 subcategories, zero-support ones counted) / 0.616 (only the 35 subcategories with at least 1 human-labeled example in this eval set)
- **Parent-level micro-F1**: 0.748 (precision 0.720, recall 0.779)
- **Parent-level macro-F1**: 0.687 / 0.744 (only the 12 parents with support in this eval set)
- **Multi-label exact-match rate** (subcategory set == human set exactly): 40.0%
- **Multi-label exact-match rate** (parent set): 53.3%
- **Mean per-review Jaccard similarity** (subcategory level, partial credit): 0.575
...
|---|---|---|---|---|---|---|---|
| metric_accuracy | 36 | 19 | 1 | 17 | 95.0% | 52.8% | 0.679 |
| feature_ui_friction | 32 | 7 | 5 | 25 | 58.3% | 21.9% | 0.318 |
| price_value_perception | 20 | 19 | 10 | 1 | 65.5% | 95.0% | 0.776 |
| ongoing_disconnects | 18 | 16 | 3 | 2 | 84.2% | 88.9% | 0.865 |
| activity_detection | 13 | 4 | 2 | 9 | 66.7% | 30.8% | 0.421 |
| support_resolution_quality | 12 | 9 | 1 | 3 | 90.0% | 75.0% | 0.818 |
| billing_disputes | 12 | 11 | 3 | 1 | 78.6% | 91.7% | 0.846 |
| sleep_accuracy | 11 | 8 | 1 | 3 | 88.9% | 72.7% | 0.800 |
| crashes_freezes | 10 | 8 | 6 | 2 | 57.1% | 80.0% | 0.667 |
| update_failures | 10 | 5 | 2 | 5 | 71.4% | 50.0% | 0.588 |
| onboarding_pairing | 9 | 6 | 0 | 3 | 100.0% | 66.7% | 0.800 |
| sleep_satisfaction | 8 | 6 | 5 | 2 | 54.5% | 75.0% | 0.632 |
| data_sync_delays | 7 | 6 | 3 | 1 | 66.7% | 85.7% | 0.750 |
| missing_activity_types | 7 | 2 | 3 | 5 | 40.0% | 28.6% | 0.333 |
| ai_positive_reception | 6 | 5 | 1 | 1 | 83.3% | 83.3% | 0.833 |
| missing_metrics | 5 | 5 | 12 | 0 | 29.4% | 100.0% | 0.455 |
| personalization_use_case_fit | 4 | 1 | 9 | 3 | 10.0% | 25.0% | 0.143 |
| comfort_fit | 4 | 3 | 3 | 1 | 50.0% | 75.0% | 0.600 |
| build_quality_perception | 4 | 2 | 5 | 2 | 28.6% | 50.0% | 0.364 |
...
| android_specific_bugs | 3 | 3 | 4 | 0 | 42.9% | 100.0% | 0.600 |
| support_responsiveness | 2 | 0 | 4 | 2 | 0.0% | 0.0% | 0.000 |
...
|---|---|---|---|---|---|---|---|
| data_accuracy | 44 | 22 | 1 | 22 | 95.7% | 50.0% | 0.657 |
| ui_ux | 34 | 20 | 9 | 14 | 69.0% | 58.8% | 0.635 |
| sync_connectivity | 33 | 30 | 4 | 3 | 88.2% | 90.9% | 0.896 |
| pricing_billing | 32 | 32 | 8 | 0 | 80.0% | 100.0% | 0.889 |
| app_stability | 20 | 14 | 7 | 6 | 66.7% | 70.0% | 0.683 |
| sleep_tracking | 20 | 17 | 7 | 3 | 70.8% | 85.0% | 0.773 |
| customer_support | 17 | 15 | 2 | 2 | 88.2% | 88.2% | 0.882 |
| feature_requests | 16 | 15 | 16 | 1 | 48.4% | 93.8% | 0.638 |
| ai_coach | 11 | 10 | 2 | 1 | 83.3% | 90.9% | 0.870 |
| hardware_wearability | 10 | 8 | 8 | 2 | 50.0% | 80.0% | 0.615 |
| platform_parity | 5 | 5 | 7 | 0 | 41.7% | 100.0% | 0.588 |
...
|---|---|---|---|---|---|
| app_stability vs sync_connectivity | 0 | 0 | 0 | 13 | 3 |
...
- **[MISMATCH]** review_id `13665043393` [app_store, 3-star]
  ...
  - predicted: activity_detection;ai_autonomy;metric_accuracy;redesign_regression
...
- **[MISMATCH]** review_id `14177657644` [app_store, 5-star]
  ...
  - human: ai_positive_reception;metric_accuracy
  - predicted: ai_positive_reception;price_value_perception
- **[MISMATCH]** review_id `14307889928` [app_store, 5-star]
  ...
  - human: ai_positive_reception;metric_accuracy
  - predicted: ai_positive_reception;sleep_satisfaction
...
### review_id `14167997703` [app_store, 3-star] — Jaccard 0.00

> I can’t believe this oversight hasn’t been fixed since it was made a few versions ago.

I’ve used behavior logging to help me improve my habits, and the trailing 90 days yes or no counts for each helped to keep me accountable. For example, I tried to keep my drinking days in the teens for every trailing 90 days, and it made a huge difference.

Whoop changed this so now it comes the remaining days of the current months as “not logged.” It’s the least helpful information to know that I haven’t logged my behaviors for the following x days of the month in the future. And it’s completely broken the trailing 90 day accountability strategy.

Fix this now please!

- **Human**: activity_detection
  - human notes: Primary fit: activity detection.
- **Predicted**: missing_metrics;redesign_regression
...
- **Predicted**: android_specific_bugs;ongoing_disconnects
...
- **Predicted**: comfort_fit;personalization_use_case_fit

### review_id `a53705ac-7ed5-423a-a1d2-02b33487d6ac` [google_play, 4-star] — Jaccard 0.00

> really cool overall.... HOWEVER I wish I could add to the journal throughout the day or change the time I fill it out to be just before bed. I literally can't remember any of that stuff the next day so it isn't accurate if I just try to remember what time I did what but ofc you can only fill out the day before the next day....seems like that should be fixed.

- **Human**: feature_ui_friction;personalization_use_case_fit
  - human notes: Primary fit: feature ui friction. Possible overlap with missing metrics.
- **Predicted**: missing_metrics
